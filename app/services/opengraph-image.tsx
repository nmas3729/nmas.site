...
export const alt = "NMAS Business IT Services – South Africa"
...
export default function ServicesOGImage() {
  return new ImageResponse(
    <div style={{ display: "flex", flexDirection: "column", width: "100%", height: "100%", background: "#0A1A2F", padding: "60px 72px", fontFamily: "'Inter', sans-serif", position: "relative" }}>
      ...
      <div style={{ color: "#00CCFF", fontSize: 15, fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.15em", marginBottom: 16 }}>Comprehensive Technology Solutions</div>
      <div style={{ color: "#ffffff", fontSize: 52, fontWeight: 900, lineHeight: 1.1, maxWidth: 800, marginBottom: 24 }}>IT Services Tailored for South Africa</div>
      <div style={{ color: "rgba(255,255,255,0.60)", fontSize: 20, maxWidth: 700, lineHeight: 1.5 }}>IT Support · Cyber Security · Cloud · Web Design · Accessories</div>
      <div style={{ position: "absolute", bottom: 48, left: 72, right: 72, display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 24 }}>
        ...
        <span style={{ color: "rgba(255,255,255,0.40)", fontSize: 14 }}>nmas.co.za/services</span>
      </div>
    </div>,
    size,
  )
